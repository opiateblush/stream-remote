...
const USER_PREFERENCE_CPU_GOOD_KEY = "cpu-ok";
const USER_PREFERENCE_CPU_OK_KEY = "cpu-sufficient";
const USER_PREFERENCE_CPU_GOOD_DEFAULT_VALUE = 0.10;
const USER_PREFERENCE_CPU_OK_DEFAULT_VALUE = 0.20;

const USER_PREFERENCE_MEMORY_GOOD_KEY = "memory-ok";
const USER_PREFERENCE_MEMORY_OK_KEY = "memory-sufficient";
const USER_PREFERENCE_MEMORY_GOOD_DEFAULT_VALUE = 1.0;
const USER_PREFERENCE_MEMORY_OK_DEFAULT_VALUE = 2.0;

const USER_PREFERENCE_SPACE_GOOD_KEY = "space-ok";
const USER_PREFERENCE_SPACE_OK_KEY = "space-sufficient";
const USER_PREFERENCE_SPACE_GOOD_DEFAULT_VALUE = 50.0;
const USER_PREFERENCE_SPACE_OK_DEFAULT_VALUE = 20.0;

const USER_PREFERENCE_DROP_GOOD_KEY = "drop-ok";
const USER_PREFERENCE_DROP_OK_KEY = "drop-sufficient";
const USER_PREFERENCE_DROP_GOOD_DEFAULT_VALUE = 0.002;
const USER_PREFERENCE_DROP_OK_DEFAULT_VALUE = 0.005;
...
{
    if (!(USER_PREFERENCE_CPU_GOOD_KEY in userPreferences))
        userPreferences[USER_PREFERENCE_CPU_GOOD_KEY] = USER_PREFERENCE_CPU_GOOD_DEFAULT_VALUE;
    ...
    if (!(USER_PREFERENCE_MEMORY_GOOD_KEY in userPreferences))
        userPreferences[USER_PREFERENCE_MEMORY_GOOD_KEY] = USER_PREFERENCE_MEMORY_GOOD_DEFAULT_VALUE;
    ...
    if (!(USER_PREFERENCE_SPACE_GOOD_KEY in userPreferences))
        userPreferences[USER_PREFERENCE_SPACE_GOOD_KEY] = USER_PREFERENCE_SPACE_GOOD_DEFAULT_VALUE;
    ...
    if (!(USER_PREFERENCE_DROP_GOOD_KEY in userPreferences))
        userPreferences[USER_PREFERENCE_DROP_GOOD_KEY] = USER_PREFERENCE_DROP_GOOD_DEFAULT_VALUE;
